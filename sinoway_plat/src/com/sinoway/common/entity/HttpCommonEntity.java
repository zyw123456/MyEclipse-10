...
public class HttpCommonEntity {
	...
	public HttpCommonEntity() {
		super();
	}

	public HttpCommonEntity(String url) {
		super();
		this.url = url;
	}
	 ...
	 */
	//private String url = "http://127.0.0.1:8080/windforce/McpHttpServlet";
	private String url = "http://10.0.1.158:8080/sinoway_mcp/httpControl";
	/**
	 * Http方法
	 */
	 ...
	 * 返回结果
	 */
	private HttpResponseCommonEntity response;
	...
	public HttpResponseCommonEntity getResponse() {
		return response;
	}

	public void setResponse(HttpResponseCommonEntity response) {
