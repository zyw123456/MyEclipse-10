...
public class DateUtil {
	...
	public static final SimpleDateFormat dateFormatHMS = new SimpleDateFormat(
			"HH:mm:ss");
	public static final SimpleDateFormat dateFormatHMS6Len = new SimpleDateFormat(
			"HHmmss");
	...
	public static final SimpleDateFormat dateFormatYMDHMSS = new SimpleDateFormat(
			"yyyyMMddHHmmssSSS");
	
	public static final SimpleDateFormat dateFormatYMDHMS17Len = new SimpleDateFormat(
			"yyyyMMdd HH:mm:ss");
	/**
	 * 得到当前的日期
	 * 
	 ...
	 * 得到当前的时间
	 * 
	 * @return 当前时间的字符串，格式为：HHmmss，如： 165720
	 * @author xiehao
	 */
	public static String getCurrentTime8Len() {
		return dateFormatHMS6Len.format(new Date());
	}
	...
	public static String getPrevDay(){
		Calendar calendar = Calendar.getInstance();  
		calendar.add(Calendar.DAY_OF_MONTH, -1);  
		return toString8Len(calendar.getTime());
	}
	 ...
	 * @return
	 */
	public static String formatDateStrYMDHMSS2YMDHMS17LenString(String dateStr){
		Date date = null;
		try {
			date = dateFormatYMDHMSS.parse(dateStr);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		return formatDateStrYMDHMS17Len(date);
	}
	
	
	
	public static String formatDateStrYMDHMS17Len(Date date){
		return dateFormatYMDHMS17Len.format(date);
	}
}
