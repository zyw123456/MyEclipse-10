...
<html>
	...
	<script type="text/javascript"
		src="${ctx}/windforce/common/js/bizlog/bizlog_logTransferPowerInfo.js"></script>
	<!-- 日期控件 -->
	<script type="text/javascript"
	...
	<body>
		...
		<div class="pageContent">
			<!-- 数据表格 -->
			<table id="logTransferPowerInfoList" style="font-size:14px;"></table>
			<!-- 分页 -->
			<div id="logTransferPowerInfoPager"></div>
		</div>
	</body>
</html>