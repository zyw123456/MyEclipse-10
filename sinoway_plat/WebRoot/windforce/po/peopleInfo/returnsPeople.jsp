...
<script type="text/javascript">
	function editOpt(sid) {
		top.startProcess("正在初始化人员修改界面,请稍等...");
		top.showPage("approvePeopleAction_initEditPeoplePage.action", "sid=" + sid,
				"编辑人员", 530, 270);
	}
	...
	<div id="poIndexDiv" style="overflow:auto;">
		...
		<table width="99%" align="left" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="20%" align="center" class="font_colors07">操作</td>
			</tr>
			<tbody style="font-size: 13px">
				<s:if test="peopleInfoList.size() ==0">
					<tr style="line-height:20px;" bgcolor="#CBD6E0">
						<td colspan="8" align="center">没有退回修改人员</td>
					</tr>
				</s:if>
				<s:else>
					<s:iterator value="peopleInfoList" var="peopleInfo" status="index">
						<tr style="line-height:20px;" 
							...
							<td align="center">
								<a style="color:#FF0000" onclick="editOpt('<s:property value="#peopleInfo.sid" />')">修改</a>
							</td>
						</tr>
					</s:iterator>
				</s:else>
