...
<script type="text/javascript">
	...
	function importFile() {
		...
		$.ajaxFileUpload({
			url : ctx+"/importPeople_importPeople.action", //用于文件上传的服务器端请求地址
		...
		<table>
			...
			<tr >
				<td style="text-align:left;">
					<span style="margin-left: 10px;">1.导入文件必须是Excel格式且按照给定的模板文件格式进行导入<a style="color:red; margin-left: 10px;"  target="_blank"  href="${ctx }/windforce/download/PeopleList.xls" >模板文件下载</a></span><br/>
					<span style="margin-left: 10px;">2.人员信息必须完整，否则导入数据会有误差</span><br/>
					<span style="margin-left: 10px;">3.从模板文件导入的人员信息如有数据异常不会进行具体提示，请参照最终导入结果</span><br/>
