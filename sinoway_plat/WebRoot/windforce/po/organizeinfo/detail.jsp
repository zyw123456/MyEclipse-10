...
var orgId = "<s:property value='organizeInfo.sid'/>";
 ...
 top.showPage("initAddUserGroup.action?_t="+ new Date().getTime(),"orgSid="+orgId,"新增人员",530,330);
}
// 点击修改按钮
function editUser(userId)
{
 top.startProcess("正在初始化人员修改界面,请稍等...");
 top.showPage("editUser_initEditPeople.action?_t="+ new Date().getTime(),"initUserId="+userId,"编辑人员",530,330);
}
// 点击删除按钮
...
function firstPage(){
 ...
 $(document).ready(function(){
	...
	var peopleTableDivWight = peopleDetailDiv-30;
