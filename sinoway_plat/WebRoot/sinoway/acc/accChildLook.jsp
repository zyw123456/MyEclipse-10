...
<script type="text/javascript"
	src='<%=request.getContextPath()%>/sinoway/acc/js/accChildLook.js'></script>
  ...
  <body>
    	<table align="center" height="100">
    		<tr align="center"><td>查看权限</td></tr>
    		<tr><td>使用人账号：<input type="text" size="15" id="peoplecode" value="${people.peopleCode }" readonly>&nbsp;&nbsp;使用人姓名：<input type="text" size="15" id="peoplename" value="${people.peopleName }" readonly>&nbsp;&nbsp;
    		团队名称：<select id="team"  ><option value='0' >${organize.orgName }</option>
    		</select> </td></tr>
    	</table>
    	<br/>
    	<br/>
    	...
    	<br/>
    	<!-- <div id="rptDiv"></div> -->
    	<div align="center"><input type="button" value="返回" onclick="history.back()"/> </div>
    	<div id="dispDiv"></div>
