...
<html>
  <head>
	...
	<script type="text/javascript"
		src='<%=request.getContextPath()%>/sinoway/stm/js/fadManager.js'></script>
	<style type="text/css">
		body{
...
<!-- 	</script> -->
  ...
  <body>
	    <div class="report_right" >
			<img src="../windforce/sinoway/common/images/u34.png" style="left:3.5%;top:44px;width:89%;height:45px;position: absolute;z-index: 1">
			<img src="../windforce/sinoway/common/images/u145.png" style="left:3.6%;top:47px;height:35px;width:180px;position: absolute;z-index: 2;">
			<span style="left:3.8%;top:47px;position:absolute;color:#FFFFFF;z-index: 3;font-size:16px;" align="center">&nbsp;&nbsp;反欺诈云模块策略制定</span>
			<br><br><br><br>
			<div style="left:3.5%;position: absolute;width:88%;">
				...
				<table  border="1px #ooo" id="veriTable"  cellpadding="0" cellspacing="0"
					width="50%" style="float: left;display: none;">
					<tr><td colspan="2" align="center">验证模块</td></tr>
				</table>
				<table  border="1px #ooo" id="exceTable"  cellpadding="0" cellspacing="0"
					width="50%" style="float: left;display: none;">
					<tr><td colspan="2" align="center">异常查询模块</td></tr>
				</table>
				...
				<table class="po_disArea" border="1px #ooo" id="poTable"  cellpadding="0" cellspacing="0"
					...
					<tr>
						<td align="center" id="orgs" width="409">
 					 
						</td>
						<td align="center" id="peoples" width="704">
						</td>
					</tr>
				</table>
			</div>
