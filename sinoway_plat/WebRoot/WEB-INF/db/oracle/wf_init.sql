...
VALUES ('7B92AE0FC4B04DB48F1AFBDB22CD7188','super','超级管理员',0,'62b7cfe4e47c0d6198eed1e1ddd7ae40',0,'00000000000000000000000000000000',0, '超级管理员',' ',' ',sysdate,0,' ');
...
VALUES ('00000000000000000000000000000000',NULL,'银之杰公共平台','http://[server]:[port]/[context]/','url','银之杰公共平台','0001',1,0,'',1,0,0);
INSERT INTO mm_moduleinfo (sid, parent_sid,name,entrypoint_url,entrypoint_type,showname,hotkeystr,order_id,module_level,tag,state,istaskview,isNavigation)
VALUES ('000000000system_manage_module_id','00000000000000000000000000000000','系统管理','http://[server]:[port]/[context]/windforce/am/','url','系统管理','0002',2,1,'',1,0,1);
INSERT INTO mm_moduleinfo (sid, parent_sid,name,entrypoint_url,entrypoint_type,showname,hotkeystr,order_id,module_level,tag,state,istaskview,isNavigation)
VALUES ('00000org_people_manage_module_id','000000000system_manage_module_id','机构人员管理','http://[server]:[port]/[context]/windforce/po/index.jsp?cud=1111111111111','url','机构人员管理','0007',7,2,'',1,0,1);
INSERT INTO mm_moduleinfo (sid, parent_sid,name,entrypoint_url,entrypoint_type,showname,hotkeystr,order_id,module_level,tag,state,istaskview,isNavigation)
VALUES ('000000000module_manage_module_id','000000000system_manage_module_id','模块管理','http://[server]:[port]/[context]/windforce/mm/moduleManager.jsp?cud=111','url','模块管理','0004',4,2,'',1,0,1);
INSERT INTO mm_moduleinfo (sid, parent_sid,name,entrypoint_url,entrypoint_type,showname,hotkeystr,order_id,module_level,tag,state,istaskview,isNavigation)
VALUES ('00000000000role_manage_module_id','000000000system_manage_module_id','角色管理','http://[server]:[port]/[context]/roles_initRole.action?cud=1111','url','角色管理','0005',5,2,'',1,0,1);
INSERT INTO mm_moduleinfo (sid, parent_sid,name,entrypoint_url,entrypoint_type,showname,hotkeystr,order_id,module_level,tag,state,istaskview,isNavigation)
VALUES ('00000role_group_manage_module_id','000000000system_manage_module_id','岗位管理','http://[server]:[port]/[context]/rolegroup_initRoleGroup.action?cud=1111','url','岗位管理','0006',6,2,'',1,0,1);
INSERT INTO mm_moduleinfo (sid, parent_sid,name,entrypoint_url,entrypoint_type,showname,hotkeystr,order_id,module_level,tag,state,istaskview,isNavigation)
VALUES ('000000000000log_manage_module_id','00000000000000000000000000000000','日志管理','http://[server]:[port]/[context]/windforce/log/','url','日志管理','0003',3,1,'',1,0,1);
...
--人员流程审批--
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('00000000return_to_edit_module_id', '000000000system_manage_module_id', '退回修改', 'http://[server]:[port]/[context]/approvePeopleAction_initReturnPage.action', 'url', '退回修改', 1, 0, '0008', 8, 2, null, 1);
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('00000000approve_reject_module_id', '000000000system_manage_module_id', '审批拒绝', 'http://[server]:[port]/[context]/approvePeopleAction_initRejectPage.action', 'url', '审批拒绝', 1, 0, '0009', 9, 2, null, 1);
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('00000000approve_people_module_id', '000000000system_manage_module_id', '人员审批', 'http://[server]:[port]/[context]/approvePeopleAction_initApprovePage.action', 'url', '人员审批', 1, 0, '0010', 10, 2, null, 1);
...
--日志--
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('0000000000000login_log_module_id', '000000000000log_manage_module_id', '用户登录日志', 'http://[server]:[port]/[context]/logLogin_initPage.action', 'url', '用户登录日志', 1, 0, '0013', 13, 2, null, 1);
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('00000000org_manage_log_module_id', '000000000000log_manage_module_id', '机构管理日志', 'http://[server]:[port]/[context]/logOrgManage_initPage.action', 'url', '机构管理日志', 1, 0, '0014', 14, 2, null, 1);
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('00000people_manage_log_module_id', '000000000000log_manage_module_id', '人员管理日志', 'http://[server]:[port]/[context]/logPeopleManage_initPage.action', 'url', '人员管理日志', 1, 0, '0015', 15, 2, null, 1);
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('0000000000transfer_log_module_id', '000000000000log_manage_module_id', '转授权日志', 'http://[server]:[port]/[context]/logTransferPowerInfo_initPage.action', 'url', '转授权日志', 1, 0, '0016', 16, 2, null, 1);
...
INSERT INTO pam_system_universal (paramId, parentParamId, paramCategory, paramname, paramvalue, orderId) VALUES ('0', '0', 'peopleType', '1', '管理用户', 1);

---机构工作时间管理---
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('000000org_working_time_module_id', '000000000system_manage_module_id', '机构工作时间管理', 'http://[server]:[port]/[context]/windforce/wt/orgWorkingTime.jsp', 'url', '机构工作时间管理', 1, 0, '1017', 17, 2, null, 1);

INSERT INTO am_powerinfo (sid,powername,powerstate,parentpower,resourceid,orderid,memo,tag) 
VALUES ('0000000org_working_time_power_id', '机构工作时间管理', '0', '0000000000system_manage_power_id', '000000org_working_time_module_id', 17, '机构工作时间管理', null);

---登录授权权限--
INSERT INTO am_powerinfo (sid,powername,powerstate,parentpower,resourceid,orderid,memo,tag) 
VALUES ('00000000login_authorize_power_id', '登录授权', '0', '0000000000system_manage_power_id', '4BDAEB988B7D44148D06E53A1BFEBE38', 18, '登录授权', null);

---区域维护---
INSERT INTO mm_moduleinfo (sid,parent_sid,name,entrypoint_url,entrypoint_type,showname,isNavigation,istaskview,hotkeystr,order_id,module_level,tag,state) 
VALUES ('00000000000area_manage_module_id', '000000000system_manage_module_id', '区域维护', 'http://[server]:[port]/[context]/areaManager_init.action', 'url', '区域维护', 1, 0, '1019', 19, 2, null, 1);

INSERT INTO am_powerinfo (sid,powername,powerstate,parentpower,resourceid,orderid,memo,tag) 
VALUES ('000000000000area_manage_power_id', '区域维护', '0', '0000000000system_manage_power_id', '00000000000area_manage_module_id', 19, '区域维护', null);
