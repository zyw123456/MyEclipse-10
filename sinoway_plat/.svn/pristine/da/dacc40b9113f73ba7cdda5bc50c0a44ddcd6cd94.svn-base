...
<html>
  <head>
	...
	<script type="text/javascript"
		src='<%=request.getContextPath()%>/sinoway/test/js/testList.js'></script>
    <style type="text/css">
    #popupcontent{
		position: absolute; 
		visibility: hidden; 
  ...
  <div id="findCreate"></div>
  		...
  		<div class="page_style" align="center">
			...
			<span style="left:160px;top:50px;position:absolute;color:#FFFFFF;z-index: 3;font-size:16px;">测试模块</span>
			<br><br>
			<br><br><br>
