...
<html>
	...
	<script type="text/javascript"
		src="${ctx}/windforce/common/js/bizlog/bizlog_logPeopleManage.js"></script>
	<!-- 日期控件 -->
	<script type="text/javascript"
	...
	<body>
		...
		<div class="pageContent">
			<!-- 数据表格 -->
			<table id="logPeopleManageList" style="font-size:14px;"></table>
			<!-- 分页 -->
			<div id="logPeopleManagePager"></div>
		</div>
	</body>
</html>