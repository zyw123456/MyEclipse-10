...
<script type="text/javascript">
	function onSavePeople() {
		...
		operAuth.authSuccess = function(authUserCode) {
			...
			$.post(top.ctx + "/doAddUser.action?_t=" + new Date().getTime(),
		...
		<div id="login_nov">
			<table>
				<tr>
					...
					<td width="30%">
						<input type="text" name="userName" onkeydown="tab('peopleCode')"
							class="mws-textinput" maxlength="50" />
					</td>
					<td width="20%" align="center" class="font_colors06">用户代码</td>
					<td width="30%">
						<input type="text" name="userCode" id="peopleCode" class="code_transform"
							maxlength="20" />
					</td>
				</tr>
				<tr>
					...
					<td width="30%">
						<input type="text" name="phone" class="mws-textinput" maxlength="20" />
					</td>
					<td width="20%" align="center" class="font_colors06">电子邮箱</td>
					<td width="30%">
						<input type="text" name="email" class="code_transform" maxlength="64" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<label>
							<s:select onchange="setRoleGroup();" list="#session.parentOrgList"
								name="userOrg" listKey="orgNo" listValue="orgName" style="width:155px;"
								value="currOrganizeInfo.orgNo" disabled="true"></s:select>
						</label>
					</td>
				...
				<tr>
					...
					<td id="roleGroups" colspan="3" valign="middle" class="font_colors06"
