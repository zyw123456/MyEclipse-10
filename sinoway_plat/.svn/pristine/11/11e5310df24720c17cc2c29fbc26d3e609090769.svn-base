    ...
    <div class="container foot">
        ...
        <div class="col-md-5 col-sm-5">
            <div class="col-md-3 col-sm-3 text-center">
                <img src="sinoway/dk2/images/day_1.png">
                <h5>今日流量</h5>
            </div>
        ...
        <div class="col-md-5 col-sm-5">
            <div class="col-md-3 col-sm-3 text-center">
                <img src="sinoway/dk2/images/day1-3.png">
                <h5>近三日流量</h5>
            </div>
            <div class="col-md-8 col-sm-8 text-left foot-rel" >
                <div id="mybarchart" class="barpos" style="width: 160px; height: 160px;">

                </div>
            </div>
        </div>
    </div>
<script src="sinoway/dk2/js/echarts/echarts.js"></script>
