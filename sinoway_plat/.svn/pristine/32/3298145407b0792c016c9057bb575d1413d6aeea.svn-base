...
CREATE TABLE
    ...
    (
        ...
        TRANSFER_PEOPLE_ID VARCHAR(255) NOT NULL,
        TRANSFER_PEOPLE_NO VARCHAR(255) NOT NULL,
        TRANSFER_PEOPLE_NAME VARCHAR(255) NOT NULL,
        TRANSFER_PEOPLE_ORG_SID VARCHAR(255) NOT NULL,
        REVICE_PEOPLE_ID VARCHAR(255),
        REVICE_PEOPLE_NO VARCHAR(255) NOT NULL,
        REVICE_PEOPLE_NAME VARCHAR(255),
        REVICE_PEOPLE_ORG_SID VARCHAR(255),
        SUPERVISE_PEOPLE_ID VARCHAR(255),
        SUPERVISE_PEOPLE_NO VARCHAR(255) NOT NULL,
        SUPERVISE_PEOPLE_NAME VARCHAR(255),
        SUPERVISE_PEOPLE_ORG_SID VARCHAR(255),
        APPLICATION_FORM_NO VARCHAR(255) NOT NULL,
        STATUS INT NOT NULL,
        APPLY_DATE VARCHAR(10) NOT NULL,
        APPLY_TIME VARCHAR(8) NOT NULL,
