...
@XmlType(name = "", propOrder = { "getBeOverdueArrearsResult" })
...
public class GetBeOverdueArrearsResponse {
	...
	/**
	 * Gets the value of the getBeOverdueArrearsResult property.
	 * 
	...
	/**
	 * Sets the value of the getBeOverdueArrearsResult property.
	 * 
	 * @param value
