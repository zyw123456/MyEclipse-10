...
public class PSend {
	...
	public static void sendHttp(){
		...
		body.put("trncods", "P0000003");
		JSONObject trninfo = new JSONObject();
		trninfo.put("prsnnam", "刘振");
		trninfo.put("idcard", "23012519890808311X");
		trninfo.put("bnkCrdNo", "6225880150613819");
		trninfo.put("mobile", "18501373321");
//		trninfo.put("passport", "s1234567");

		body.put("trninfo", trninfo);
		...
		try {
			...
			u = u + "&chnlcod=50000001&prdcod=10000001&isbatch=0&msgtype=1";
			URL url = new URL(u);
	...
	public static void socketSend(){
		try {
			try {
				...
				String trdCod= "00000000";
				String prdCod = "10000001";
				String isBatch = "0";
				String chcCod = "";
				String msgType = "1";
				String msgLen = "";
