...
@XmlType(name = "", propOrder = { "getBeOverduePlatformResult" })
...
public class GetBeOverduePlatformResponse {
	...
	/**
	 * Gets the value of the getBeOverduePlatformResult property.
	 * 
	...
	/**
	 * Sets the value of the getBeOverduePlatformResult property.
	 * 
	 * @param value
