 ...
 * 
 */
public class TradeProcException extends Exception {
	...
	public TradeProcException() {
		super();
	}

	public TradeProcException(Exception e) {
		super(e);
	}

	public TradeProcException(String errorMsg) {
		super(errorMsg);
	}

	public TradeProcException(String errorMsg, Exception e) {
		super(errorMsg, e);
	}

	public TradeProcException(TradeProcException e) {
		super(e);
	 ...
	 *            错误信息码
	 */
	public TradeProcException(String sysName, int errTypeCode, int errInfoCode) {
		super();
